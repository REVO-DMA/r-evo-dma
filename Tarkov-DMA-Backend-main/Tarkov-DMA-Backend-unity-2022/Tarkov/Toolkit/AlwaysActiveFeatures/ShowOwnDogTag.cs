...
{
    public class ShowOwnDogTag : AlwaysActiveFeature
    {
        private const string thisID = "showOwnDogTag";
        ...
        public ShowOwnDogTag(int delayMs) : base(delayMs, thisID) { }
        ...
        public override void Run(ref List<ScatterWriteEntry> writes, params object[] parameters)
        {
            ...
            PatchMethod(ClassNames.InventoryController.ClassName, ClassNames.InventoryController.ShowOwnDogTagMethod, sigInfo, compileClass: true);
