...
namespace vmmsharp
{
    ...
    public static partial class lc
    {
        ...
        public static partial void Close(ulong hLC);
        ...
        public static partial bool GetOption(ulong hLC, ulong fOption, out ulong pqwValue);

        [LibraryImport("leechcore.dll", EntryPoint = "LcSetOption")]
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static partial bool SetOption(ulong hLC, ulong fOption, ulong qwValue);
    ...
    internal static partial class lci
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static unsafe partial bool LcRead(ulong hLC, ulong pa, uint cb, byte* pb);

        [LibraryImport("leechcore.dll", EntryPoint = "LcReadScatter")]
        [SuppressUnmanagedCodeSecurity]
        internal static unsafe partial void LcReadScatter(ulong hLC, uint cMEMs, IntPtr ppMEMs);

        [LibraryImport("leechcore.dll", EntryPoint = "LcWrite")]
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static unsafe partial bool LcWrite(ulong hLC, ulong pa, uint cb, byte* pb);

        [LibraryImport("leechcore.dll", EntryPoint = "LcWriteScatter")]
        [SuppressUnmanagedCodeSecurity]
        internal static unsafe partial void LcWriteScatter(ulong hLC, uint cMEMs, IntPtr ppMEMs);

        [LibraryImport("leechcore.dll", EntryPoint = "LcCommand")]
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static unsafe partial bool LcCommand(ulong hLC, ulong fOption, uint cbDataIn, byte* pbDataIn, out IntPtr ppbDataOut, out uint pcbDataOut);
    }
