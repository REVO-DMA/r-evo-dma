namespace cs2_dma_esp.SDK.Resourcesystem 
{
    ...
    {
        public const uint m_programBuffer = 0x0; // CUtlVector<uint8_t>
        public const uint m_variablesRead = 0x18; // CUtlVector<FuseVariableIndex_t>
        public const uint m_variablesWritten = 0x30; // CUtlVector<FuseVariableIndex_t>
        public const uint m_nMaxTempVarsUsed = 0x48; // int32_t
    }

    public static class CFuseSymbolTable 
    {
        public const uint m_constants = 0x0; // CUtlVector<ConstantInfo_t>
        public const uint m_variables = 0x18; // CUtlVector<VariableInfo_t>
        public const uint m_functions = 0x30; // CUtlVector<FunctionInfo_t>
        public const uint m_constantMap = 0x48; // CUtlHashtable<CUtlStringToken,int32_t>
        public const uint m_variableMap = 0x68; // CUtlHashtable<CUtlStringToken,int32_t>
        public const uint m_functionMap = 0x88; // CUtlHashtable<CUtlStringToken,int32_t>
    }

    public static class ConstantInfo_t 
    {
        public const uint m_name = 0x0; // CUtlString
        public const uint m_nameToken = 0x8; // CUtlStringToken
        public const uint m_flValue = 0xC; // float
    }
    ...
    public static class FourQuaternions 
    {
        ...
        public const uint z = 0x20; // fltx4
        public const uint w = 0x30; // fltx4
    }

    public static class FunctionInfo_t 
    {
        public const uint m_name = 0x8; // CUtlString
        public const uint m_nameToken = 0x10; // CUtlStringToken
        public const uint m_nParamCount = 0x14; // int32_t
        public const uint m_nIndex = 0x18; // FuseFunctionIndex_t
        public const uint m_bIsPure = 0x1A; // bool
    }
    ...
    {
        public const uint m_name = 0x0; // CUtlString
        public const uint m_child = 0x8; // CStrongHandle<InfoForResourceTypeManifestTestResource_t>
    }

    public static class PackedAABB_t 
    {
        public const uint m_nPackedMin = 0x0; // uint32_t
        public const uint m_nPackedMax = 0x4; // uint32_t
    }
    ...
    public static class VariableInfo_t 
    {
        public const uint m_name = 0x0; // CUtlString
        public const uint m_nameToken = 0x8; // CUtlStringToken
        public const uint m_nIndex = 0xC; // FuseVariableIndex_t
        public const uint m_nNumComponents = 0xE; // uint8_t
        public const uint m_eVarType = 0xF; // FuseVariableType_t
        public const uint m_eAccess = 0x10; // FuseVariableAccess_t
    }
}
