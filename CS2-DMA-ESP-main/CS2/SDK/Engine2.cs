namespace cs2_dma_esp.SDK.Engine2 
{
    ...
    {
        public const uint m_flags = 0x8; // uint32_t
        public const uint m_pInfo = 0x10; // EntComponentInfo_t*
        public const uint m_nPriority = 0x18; // int32_t
        public const uint m_pNext = 0x20; // CEntityComponentHelper*
    }

    public static class CEntityIOOutput 
    {
        public const uint m_Value = 0x18; // CVariantBase<CVariantDefaultAllocator>
    }
    ...
    {
        public const uint m_PathIndex = 0x20; // ChangeAccessorFieldPathIndex_t
    }
    ...
    {
        public const uint m_nPlatWindowWidth = 0x18; // int32_t
        public const uint m_nPlatWindowHeight = 0x1C; // int32_t
        public const uint m_nRenderWidth = 0x20; // int32_t
        public const uint m_nRenderHeight = 0x24; // int32_t
    }

    public static class EntComponentInfo_t 
    {
        public const uint m_pName = 0x0; // char*
        public const uint m_pCPPClassname = 0x8; // char*
        public const uint m_pNetworkDataReferencedDescription = 0x10; // char*
        public const uint m_pNetworkDataReferencedPtrPropDescription = 0x18; // char*
        public const uint m_nRuntimeIndex = 0x20; // int32_t
        public const uint m_nFlags = 0x24; // uint32_t
        public const uint m_pBaseClassComponentHelper = 0x60; // CEntityComponentHelper*
    }
    ...
    {
        public const uint m_nCurrentTick = 0x30; // int32_t
        public const uint m_nCurrentTickThisFrame = 0x34; // int32_t
        public const uint m_nTotalTicksThisFrame = 0x38; // int32_t
        public const uint m_nTotalTicks = 0x3C; // int32_t
    }

    public static class EventAppShutdown_t 
    {
        public const uint m_nDummy0 = 0x0; // int32_t
    }
    ...
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_flRealTime = 0x28; // float
        public const uint m_flFrameTime = 0x2C; // float
    }

    public static class EventClientOutput_t 
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_flRenderTime = 0x28; // float
        public const uint m_flRealTime = 0x2C; // float
        public const uint m_flRenderFrameTimeUnbounded = 0x30; // float
        public const uint m_bRenderOnly = 0x34; // bool
    }
    ...
    {
        public const uint m_nTickCount = 0x0; // int32_t
    }
    ...
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_flRenderTime = 0x28; // double
        public const uint m_flRenderFrameTime = 0x30; // float
        public const uint m_flRenderFrameTimeUnbounded = 0x34; // float
        public const uint m_bRenderOnly = 0x38; // bool
    }
    ...
    public static class EventClientPreOutput_t 
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_flRenderTime = 0x28; // double
        public const uint m_flRenderFrameTime = 0x30; // double
        public const uint m_flRenderFrameTimeUnbounded = 0x38; // double
        public const uint m_flRealTime = 0x40; // float
        public const uint m_bRenderOnly = 0x44; // bool
    }
    ...
    public static class EventClientProcessInput_t 
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_flRealTime = 0x28; // float
        public const uint m_flTickInterval = 0x2C; // float
        public const uint m_flTickStartTime = 0x30; // double
    }
    ...
    {
        public const uint m_bThreadsActive = 0x0; // bool
    }

    public static class EventClientSendInput_t 
    {
        public const uint m_bFinalClientCommandTick = 0x0; // bool
        public const uint m_nAdditionalClientCommandsToCreate = 0x4; // int32_t
    }
    ...
    {
        public const uint m_flFrameTime = 0x0; // float
    }
    ...
    {
        public const uint m_nCount = 0x0; // int32_t
    }
    ...
    {
        public const uint m_nSplitScreenSlot = 0x0; // CSplitScreenSlot
    }
    ...
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_nClientOutputFrames = 0x28; // int32_t
        public const uint m_flRealTime = 0x30; // double
        public const uint m_flRenderTime = 0x38; // double
        public const uint m_flRenderFrameTime = 0x40; // double
        public const uint m_flRenderFrameTimeUnbounded = 0x48; // double
        public const uint m_flRenderFrameTimeUnscaled = 0x50; // double
        public const uint m_flTickRemainder = 0x58; // double
    }
    ...
    {
        public const uint m_LoopState = 0x0; // EngineLoopState_t
        public const uint m_bFirstTick = 0x28; // bool
        public const uint m_bLastTick = 0x29; // bool
    }
