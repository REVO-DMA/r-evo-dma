...
namespace gzw_dma_backend.DMA.Collections
{
    /// <summary>
    ...
    public readonly struct SharedMemory<T> : IMemCollection<T>, IDisposable where T : unmanaged
    {
        ...
        public readonly IEnumerator<T> GetEnumerator() => new SharedMemEnumerator<T>(_arr, _count);
