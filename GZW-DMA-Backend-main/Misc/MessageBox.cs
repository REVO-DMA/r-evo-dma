namespace gzw_dma_backend.Misc
{
    public static class MessageBox
    {
        ...
        {
            /// <summary>
            /// The first button is the default button. Button1 is the default unless Button2, Button3, or Button4 is specified.
            /// </summary>
            Button1 = 0x00000000,
            /// <summary>
        ...
        public enum MessageBoxModal : uint
        {
            ...
            ///
            /// Application is the default if neither System nor Task is specified.
            /// </summary>
            Application = 0x00000000,
            /// <summary>
            /// Same as Application except that the message box has the WS_EX_TOPMOST style.
            ...
            System = 0x00001000,
            /// <summary>
            /// Same as Application except that all the top-level windows belonging to the current thread are disabled if the hWnd parameter is NULL.
