...
namespace arena_dma_backend.Mono
{
    public static class Patcher
    {
        ...
        public static void PatchMethod(in string className, in string methodName, in SignatureInfo sigInfo, in string assemblyName = "Assembly-CSharp", in bool compileClass = false, in bool compileMethod = true)
        {
            ...
            var mClass = MonoAPI.Class.FindOne(assemblyName, className);
            if ((ulong)mClass == 0x0)
        ...
        public static void PatchMethod(in MonoAPI.Class mClass, in string className, in string methodName, in SignatureInfo sigInfo, in bool compileClass = false, in bool compileMethod = true)
        {
            static string GetName(string className)
            {
                return $"({className})";
        ...
        public static void PatchMethod(in MonoAPI.MonoMethod mMethod, in string className, in string methodName, in SignatureInfo sigInfo, in bool compile = true)
        {
