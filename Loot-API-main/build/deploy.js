...
async function deployWeb() {
    ...
    if (environment === "prod") destination += "loot-api.evodma.com";

    console.log("Stopping API...");
    await sshExec(`pm2 stop loot-api`);
    ...
    await sshExec(`pm2 start ${destination}/index.js --name loot-api`);
    // pm2 start index.js --name loot-api
